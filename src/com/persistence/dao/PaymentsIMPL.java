...
@Override
public Customer_Transaction[] getAllPendingCustomerTransactionDetails() {
	try {
		Connection con=c.getConnection();
		Statement stmt1=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, 
                ResultSet.CONCUR_UPDATABLE);  
		ResultSet rs1=stmt1.executeQuery("select * from transaction where status='pending'");
		int i=0,count=0;
		//System.out.println("Hello"+count);
		while (rs1.next())
		{
...
@Override
public Bank_to_Customer[] getAllPendingBankToCustomerDetails() {
	try {
		Connection con=c.getConnection();
		Statement stmt1=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, 
                ResultSet.CONCUR_UPDATABLE);  
...
@Override
public Customer_to_Bank[] getAllPendingCustomerToBankDetails() {
	try {
		Connection con=c.getConnection();
		Statement stmt1=con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, 
                ResultSet.CONCUR_UPDATABLE);  
...
public static void main(String[] args) throws ParseException {
	...
	//Customer_Transaction ct1[]=p.getAllPendingCustomerTransactionDetails();
